...
export class RippleComponent implements OnInit, AfterViewInit {
   ...
   * Get and bind top style.
   */
  @HostBinding('style.margin-top') get marginTop(): string {
   ...
   * Get and bind left style.
   */
  @HostBinding('style.margin-left') get marginLeft(): string {
    return `${-(this.size / 2)}px`;
  }
